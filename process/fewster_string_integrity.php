<?PHP
	...
	class fewster_string_integrity{
		...
		function scripts(){
			if(isset($_GET['page'])){
				if($_GET['page']=="fewster-integrity-susp"){
		...
		function menu_create(){
			add_submenu_page( "fewster-anti-bad", __("Suspicious file check"), __("Suspicious file check"), "manage_options", "fewster-integrity-susp", array($this, "integrity") );
		}
		...
		function integrity(){
			...
			$files = $library->suspicious_files_list();
	...
	$fewster_string_integrity = new fewster_string_integrity();