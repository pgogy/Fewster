<?PHP
	...
	class fewster_plugin_integrity{
		...
		function scripts(){
			if(isset($_GET['page'])){
				if($_GET['page']=="fewster-integrity-plugins"){
		...
		function menu_create(){
			add_submenu_page( "fewster-anti-bad", __("Plugin and Theme Integrity"), __("Plugin and Theme Integrity"), "manage_options", "fewster-integrity-plugins", array($this, "integrity") );
		}
		...
		function integrity(){
			...
			?><h2><?PHP echo __("Plugins and Themes Integrity Check"); ?></h2><?PHP
			...
			$files = $library->plugin_files_list();
	...
	$fewster_plugin_integrity = new fewster_plugin_integrity();